...
C ----------------------------------------------------------------
        ...
        ! write(6,*)
		xA  = PROPS(10)    ! IL6 PCR Expression
		xB  = PROPS(11)    ! IL6 PCR Expression
		x6  = PROPS(12)    ! IL6 PCR Expression
...
! 	  Use stress from previous increment
	  ...
	  Xparams(8) = xA    ! Factoring term for TNF-a
	  Xparams(9) = xB    ! Factoring term for TGF-B
	  Xparams(10) = x6    ! Factoring term for IL-6
...
C 	  Growth Parameters (only needed in SUBROUTINE)
	  ...
	  xTNF = Xparams(5)   ! TNF PCR Expression
	  xTGF = Xparams(6)    ! TGF PCR Expression
	  xLeu  = Xparams(7)    ! IL-6 PCR Expression
      xtrS = Xparams(1) ! trace of stress
      ct   = y(1) ! number of cells
	  xa1 = Xparams(8) !-0.05
	  xb1 = Xparams(9) !-0.060
	  xc1 = Xparams(10) !0.009
